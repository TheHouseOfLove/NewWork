...
package com.abl.RWD.component.datepicker.view;
...
import com.abl.RWD.component.datepicker.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void initData(Context context) {
		...
		this.colorLine = getResources().getColor(R.color.province_line_border);
	}
...
//		int childSize = itemsLayout.getChildCount();
//		MyLog.debug("WheelView","[initItemView] currentItem:"+currentItem+"   count:"+itemsLayout.getChildCount()+
//				"firstItem:"+firstItem);
//		for (int i = 0; i < childSize; i++) {
//			TextView itemView = (TextView) itemsLayout.getChildAt(i);
//			if (null == itemView) {
//				return;
//			}
//			if ((currentItem) == i) {
