...
public class AdapterDetailInfo extends BaseRecyclerAdapter<DetailItemHolder,PYWInfoItemEntity>{
    public AdapterDetailInfo(Context mContext, ArrayList<PYWInfoItemEntity> mList) {
